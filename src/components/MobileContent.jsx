...
import { LineChartOutlined, HomeOutlined, BarChartOutlined, MoreOutlined, BranchesOutlined, BuildOutlined, ShoppingOutlined, UnorderedListOutlined } from '@ant-design/icons';
...
const MobileContent = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (showOverflowMenu && overflowMenuRef.current && !overflowMenuRef.current.contains(event.target)) {
  ...
  return (
    <div className="bg-dark-bg rounded-lg p-1 pl-2 pr-3 pt-1 flex flex-col flex-1 overflow-y-auto font-family-roboto relative">
      ...
      <div className='flex justify-between mt-2 border-t border-neutral-700 pt-2'>
        ...
        >
          <UnorderedListOutlined style={{ fontSize: 24, fontWeight: 700, strokeWidth: 2 }} />
        </div>
        <div
        ...
        >
          <HomeOutlined style={{ fontSize: 24, fontWeight: 700, strokeWidth: 2 }} />
        </div>
        <div
        ...
        >
          <LineChartOutlined style={{ fontSize: 24, fontWeight: 700, strokeWidth: 2 }} />
        </div>
        <div
        ...
        >
          <BarChartOutlined style={{ fontSize: 24, fontWeight: 700, strokeWidth: 2 }} />
        </div>
        <div
          ref={overflowMenuRef}
        ...
        >
          <MoreOutlined style={{ fontSize: 24, fontWeight: 700, strokeWidth: 2 }} />
          ...
          {showOverflowMenu && (
            <div className="absolute bottom-full right-0 mb-2 bg-dark-bg-2 border border-neutral-700 rounded-lg shadow-lg z-50 min-w-48">
              ...
              >
                ...
                <span className="text-sm text-neutral-300">Strategy Builder</span>
              </div>
              <div
                className="flex items-center gap-3 px-4 py-3 cursor-pointer hover:bg-neutral-700 transition-colors"
                onClick={() => {
