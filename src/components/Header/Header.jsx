...
const Header = () => {
  ...
  const [headerScripts, setHeaderScripts] = React.useState(() =>
  ...
  const [allowAccountLogout, setAllowAccountLogout] = React.useState(
    () => userStore.userStore.allowAccountLogout
  );
  const [accountLogoutTime, setAccountLogoutTime] = React.useState(
    ...
    <>
      ...
      <div className="flex items-center justify-between !bg-dark-bg px-2 py-0 pt-2 md:py-2 shadow-md shadow-neutral-800 font-family-roboto">
        ...
        <div className="flex items-center">
          ...
          <button
            className="hidden md:block items-center !text-logo-green font-bold py-1 rounded focus:outline-none cursor-pointer"
