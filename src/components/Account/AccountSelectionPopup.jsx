...
const AccountSelectionPopup = ({ isOpen }) => {
  ...
  const [selectedAccountId, setSelectedAccountId] = useState(userStore.userStore.accountId);
  ...
  return (
    <Modal
      ...
      maskClosable={true}
      width={500}
      classNames={{ body: "p-0 bg-neutral-800 border-neutral-700 border border-solid rounded-md" }}
      ...
      <div className="p-3  font-family-roboto">
        <div className="flex items-center justify-between mb-2">
          <div
            role="button"
            tabIndex={0}
            className="flex items-center gap-2 bg-neutral-900 hover:bg-neutral-900/50 active:bg-neutral-600 text-price-green font-bold rounded-md px-5 py-2 cursor-pointer select-none"
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="inline-block">
              <line x1="12" y1="5" x2="12" y2="19" />
              <line x1="5" y1="12" x2="19" y2="12" />
            </svg>
            Add Account
          </div>
          <button onClick={handleClose} className="text-gray-300 text-lg font-medium hover:text-white"><span className="ml-1">&#10005;</span></button>
        </div>
