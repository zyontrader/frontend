  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60 font-family-roboto">
      <div className="bg-dark-bg rounded-xl shadow-2xl border border-neutral-700 w-full max-w-md p-0 relative">
        {/* Header */}
        <div className="bg-header-green rounded-t-xl px-6 py-3 text-lg font-bold text-black">
          Login To Trade
        </div>
        {/* Error message */}
        {error && (
        ...
        <form className="flex flex-col gap-2 px-8 py-6" onSubmit={handleLogin}>
          <label
            className="text-neutral-400 text-sm font-bold mt-2"
            htmlFor="username"
          >
          ...
          <div className="flex gap-4 mt-2">
            <button
              type="submit"
              className="flex-1 border-2 cursor-pointer border-green-500 !text-green-500 rounded py-2 font-semibold hover:bg-green-500 hover:!text-black transition flex items-center justify-center"
              disabled={loading}
            >
              {loading && <Spinner />}
              Login
            ...
            <button
              type="button"
              className="flex-1 border-2 cursor-pointer border-green-500 !text-green-500 rounded py-2 font-semibold hover:bg-green-500 hover:!text-black transition"
              disabled={loading}
            >
              Sign Up
            </button>
