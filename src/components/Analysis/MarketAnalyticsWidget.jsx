    ...
    <div className="flex flex-col flex-1">
      {data.map((idx) => (
        ...
        >
          ...
          <div
            className={`rounded-md p-1 flex md:flex-col items-center justify-center w-[130px] ${
              idx.change >= 0 ? "bg-price-green" : "bg-price-red"
            }`}
          >
      ...
      {data.map((idx) => (
        ...
        >
          ...
          <div className="flex w-full">
            <div
              className={`p-1 flex flex-col flex-1 items-center justify-center ${
    ...
    <div className="bg-black shadow-lg rounded-lg shadow flex flex-col mx-2 relative overflow-hidden">
      ...
      <div
        className={`flex flex-col items-center justify-center flex-1 ${
          isPositive ? "bg-price-green" : "bg-price-red"
        }`}
      >
...
const MarketAnalyticsWidget = forwardRef((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex-col flex md:flex-row mb-4 md:gap-4">
        ...
        <div className="flex flex-col w-full md:w-auto md:min-w-[300px] md:mr-2 md:gap-2">
          <Card
            size="small"
